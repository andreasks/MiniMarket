Public Class UCPemasok
    ...
    Sub Kode_Pemasok()
        ...
        Tampil.CommandText = "select * from TblPemasok order by Kode_Pemasok Asc"
        Tampilkan = Tampil.ExecuteReader

        If Tampilkan.HasRows = True Then
            While Tampilkan.Read()
                TxtKode.Text = Tampilkan("Kode_Pemasok")
            End While
    ...
    Private Sub BtnSimpan_Click(sender As Object, e As EventArgs) Handles BtnSimpan.Click
        ...
        Try
            ...
            DMLSql.CommandText = "Insert into TblPemasok values('" & TxtKode.Text & "','" & TxtNama.Text & "','" & _
    ...
    Private Sub DGV_CellMouseClick(sender As Object, e As DataGridViewCellMouseEventArgs)
        ...
        Tampil.Connection = Database
        Tampil.CommandType = CommandType.Text
        Tampil.CommandText = "select * from TblPemasok where Kode_Pemasok = '" & TxtKode.Text & "' "
        Tampilkan = Tampil.ExecuteReader
        If Tampilkan.HasRows = True Then
            Tampilkan.Read()
            TxtKode.Text = Tampilkan("Kode_Pemasok")
            TxtNama.Text = Tampilkan("Nama_Pemasok")
    ...
    Private Sub BtnUbah_Click(sender As Object, e As EventArgs) Handles BtnUbah.Click
        ...
        Try
            ...
            DMLSql.CommandText = "update TblPemasok set Nama_Pemasok='" & TxtNama.Text & "',Alamat='" & _
               TxtAlamat.Text & "',Telepon='" & Val(TxtNo.Text) & "' where Kode_Pemasok = '" & TxtKode.Text & "' "
            DMLSql.ExecuteNonQuery()
    ...
    Private Sub BtnHapus_Click(sender As Object, e As EventArgs) Handles BtnHapus.Click
        Try
            ...
            DMLSql.CommandText = "Delete from TblPemasok where Kode_Pemasok = '" & TxtKode.Text & "' "
            DMLSql.ExecuteNonQuery()
